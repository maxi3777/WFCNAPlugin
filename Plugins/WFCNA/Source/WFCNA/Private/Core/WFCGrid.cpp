...
int32 UWFCGrid::CombineRotations(int32 RotationA, int32 RotationB) const
{
	unimplemented();
	return INDEX_NONE;
}
...
FVector UWFCGrid::GetCenterOffsetToOrigin(FIntVector GridLocation) const
{
...
TSharedPtr<FAsyncGrid> UWFCGrid::CreateAsyncGrid()
{
	return MakeShared<FAsyncGrid>();
}
