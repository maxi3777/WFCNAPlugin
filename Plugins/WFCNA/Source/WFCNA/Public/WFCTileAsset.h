...
struct WFCNA_API FWFCModelAssetTile : public FWFCModelTile
{
	GENERATED_BODY()
...
class WFCNA_API UWFCTileAsset : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	virtual TArray<FActorInfoEntry> GetTileDefActorsInfo(int32 TileDefIndex) const;

	virtual TArray<FStaticMeshInfoEntry> GetTileDefMeshesInfo(int32 TileDefIndex) const;

	virtual TSubclassOf<UWFCUnit> GetTileDefUnit(int32 TileDefIndex) const;
