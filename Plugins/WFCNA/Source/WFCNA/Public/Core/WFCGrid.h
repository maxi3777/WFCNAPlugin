...
class WFCNA_API UWFCGridConfig : public UObject
{
	GENERATED_BODY()
...
class WFCNA_API UWFCGrid : public UObject
{
	GENERATED_BODY()
...
public:
	...
	virtual FVector GetCenterOffsetToOrigin(FIntVector GridLocation) const;
	...
	virtual TSharedPtr<FAsyncGrid> CreateAsyncGrid();
};
