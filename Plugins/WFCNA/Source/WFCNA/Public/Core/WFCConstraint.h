...
class WFCNA_API UWFCConstraintSnapshot : public UObject
{
	GENERATED_BODY()
};
...
class WFCNA_API UWFCConstraint : public UObject
{
	GENERATED_BODY()
...
public:
	...
	virtual TUniquePtr<FAsyncConstraint> CreateAsyncConstraint(FAsyncGenerator* InGenerator, TSharedPtr<FAsyncGrid> InGrid, TSharedPtr<FAsyncModel> InModel);

	FAsyncConstraint* AsyncConstraintForSnapshot;
